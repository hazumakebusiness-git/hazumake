...
urlpatterns = [
    ...
    # Use legacy password-based views by default; magic-link available separately
    ...
    # Friendly styled change password route
    path('change-password/', views.change_password_view, name='change_password'),
    # Provide conventional names so templates linking to `password_change` still work
    path('password_change/', views.change_password_view, name='password_change'),
    path('password_change/done/', views.password_change_done, name='password_change_done'),
    # Custom password reset routes (must come before django.contrib.auth.urls)
