...
EXPAY_USER_TOKEN = os.environ.get('EXPAY_USER_TOKEN', '')
EXPAY_WEBHOOK_SECRET = os.environ.get('EXPAY_WEBHOOK_SECRET', '')
EXPAY_REDIRECT_URL = os.environ.get('EXPAY_REDIRECT_URL', '')
...
if not DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = os.environ.get(
        ...
        'https://hazumakestore.com,https://www.hazumakestore.com'
    ).split(',')